...
//      public boolean textShadow = false;
        ...
        public void bindTexture(ResourceLocation rsrc, int usize, int vsize) {
            ...
            SGCraft.log.trace(String.format("BaseGuiContainer.bindTexture: %s size (%s, %s) scale (%s, %s)", rsrc, usize, vsize, gstate.uscale, gstate.vscale));
        }
    ...
    public static class Widget implements IWidget {
        ...
        public IWidget dispatchMousePress(int x, int y, int button) {
            SGCraft.log.trace(String.format("BaseGui.Widget.dispatchMousePress: (%s, %s) in %s", x, y, getClass().getSimpleName()));
            return this;
        }
    ...
    public static class Group extends Widget implements IWidgetContainer {
        ...
        public void setFocus(IWidget widget) {
            SGCraft.log.trace(String.format("BaseGui.Group.setFocus: of %s to %s", getClass().getSimpleName(), widget.getClass().getSimpleName()));
            focus = widget;
        }
        ...
        @Override
        public IWidget dispatchMousePress(int x, int y, int button) {
            SGCraft.log.trace(String.format("BaseGui.Group.dispatchMousePress: (%s, %s) in %s", x, y, getClass().getSimpleName()));
