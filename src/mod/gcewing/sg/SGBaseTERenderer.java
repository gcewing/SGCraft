...
class SGBaseTERenderer extends BaseTileEntityRenderer {
    ...
    static final int[][] chevronEngagementSequences = {
            {9, 3, 4, 5, 6, 0, 1, 2, 9}, // 7 symbols (9 = never enganged)
            {7, 3, 4, 5, 8, 0, 1, 2, 6}  // 9 symbols
    };

    static final double[] s = new double[numRingSegments + 1];
    static final double[] c = new double[numRingSegments + 1];
    ...
    void chevron(boolean engaged) {
        ...
        double w2 = w1 * 1.25;
        double x1 = chevronInnerRadius;
        double y1 = chevronWidth / 4;
        double x2 = chevronOuterRadius;
