...
public class OCIntegration extends IntegrationBase {
    ...
    public void registerRecipes() {
        ...
        if (cable != null && microchip1 != null && pcb != null) {
            if (mod.config.getBoolean("recipes", "ocInterfaceBlock", true)) {
                mod.newRecipe("ocInterface", ocInterface, 1, "ini", "cmc", "ibi", 'i', Items.IRON_INGOT, 'n', "ingotNaquadahAlloy", 'c', cable, 'm', microchip1, 'b', pcb);
            }
        }
    }
