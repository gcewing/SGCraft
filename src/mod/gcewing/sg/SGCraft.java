...
@Mod(modid = Info.modID, name = Info.modName, version = Info.versionNumber, acceptableRemoteVersions = Info.versionBounds)
public class SGCraft extends BaseMod<SGCraftClient> {
    ...
    protected void registerFallbackPowerBlockRecipe() {
        newRecipe(rfPowerUnit, 1, "cgc", "gIg", "crc", 'c', ic2Capacitor, 'g', Items.gold_ingot, 'I', Blocks.iron_block, 'r', Items.redstone);
    }
    ...
    protected void registerWorldGenerators() {
        if (config.getBoolean("options", "enableNaquadahOre", true)) {
            System.out.print("SGCraft: Registering NaquadahOreWorldGen\n");
