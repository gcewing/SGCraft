...
public class Matrix3 {
    ...
    public static final Matrix3 ident = new Matrix3();

    public static final Matrix3[] turnRotations = {
            rotY(0), rotY(90), rotY(180), rotY(270)
    };

    public static final Matrix3[] sideRotations = {
            /*0, -Y, DOWN */ ident,
            /*1, +Y, UP   */ rotX(180),
            /*2, -Z, NORTH*/ rotX(90),
    ...
    public static final Matrix3[][] sideTurnRotations = new Matrix3[6][4];
