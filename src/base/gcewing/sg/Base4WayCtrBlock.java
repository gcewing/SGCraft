...
public class Base4WayCtrBlock<TE extends TileEntity> extends BaseOrientedCtrBlock<TE> {
	...
	public Base4WayCtrBlock(Material material) {
		this(material, null);
	}
	
	public Base4WayCtrBlock(Material material, Class<TE> teClass) {
...
//	@Override
//	public IIcon getBlockTextureFromSideAndMetadata(int side, int data) {
