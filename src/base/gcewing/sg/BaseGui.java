...
//      public boolean textShadow = false;
        ...
        public void gRestore() {
            if (gstate.previous != null) {
                ...
                System.out.print("BaseGui: Warning: Graphics state stack underflow\n");
        }
        ...
        public void drawBorderedRect(double x, double y, double w, double h,
            ...
            double x1 = x + cornerWidth, x2 = w - cornerWidth;
            double y1 = y + cornerHeight, y2 = h - cornerHeight;
            double u1 = u + cornerWidth, u2 = u + uSize - cornerWidth;
            double v1 = v + cornerHeight, v2 = v + vSize - cornerHeight;
            drawTexturedRect(x, y, cornerWidth, cornerHeight, u, v);               // top left corner
            drawTexturedRect(x2, y, cornerWidth, cornerHeight, u2, v);             // top right corner
            drawTexturedRect(x, y2, cornerWidth, cornerHeight, u, v2);             // bottom left corner
            drawTexturedRect(x2, y2, cornerWidth, cornerHeight, u2, v2);           // bottom right corner
            drawTexturedRect(x1, y, sw, cornerHeight, u1, v, usw, cornerHeight);    // top side
            drawTexturedRect(x1, y2, sw, cornerHeight, u1, v2, usw, cornerHeight);  // bottom side
            drawTexturedRect(x, y1, cornerWidth, sh, u, v1, cornerWidth, ush);    // left side
            drawTexturedRect(x2, y1, cornerWidth, sh, u2, v1, cornerWidth, ush);  // right side
