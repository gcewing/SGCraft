        ...
        if (scrnCls != null) {
            ...
            if (contCls != null) {
                try {
                    ...
                    if (base.debugGui)
                        System.out.print("BaseModClient.getClientGuiElement: Instantiating container\n");
                    Object cont = base.createGuiElement(contCls, player, world, pos, param);
                    if (cont != null) {
                        if (base.debugGui)
                            System.out.print("BaseModClient.getClientGuiElement: Instantiating screen with container\n");
                        try {
