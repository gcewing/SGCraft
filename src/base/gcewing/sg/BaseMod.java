...
public class BaseMod<CLIENT extends BaseModClient<? extends BaseMod>>
    ...
    final Map<Class<? extends Container>, Class<? extends TileEntity>> containerTEClasses = new HashMap<>();
    final Map<Object, Integer> objectToGuiId = new HashMap<>();
    final Map<Integer, Class<? extends Container>> containerClasses =
            new HashMap<>();
